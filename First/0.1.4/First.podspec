#
#  Be sure to run `pod spec lint First.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/AnChangSu/First"
 ...
 s.ios.deployment_target = "7.0"
  ...
  s.source = { :git => "https://github.com/AnChangSu/First.git", :tag => "#{s.version}" }
